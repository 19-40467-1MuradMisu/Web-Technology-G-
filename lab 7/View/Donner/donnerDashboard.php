        ...
        <tr>
          <td>
            ...
            <ul>
              ...
              <li><a href="./donnerDonateMoney.php">Donate Money</a></li>
              <li><a href="./searchApplicantList.php">Search Applicant List</a></li>
              <li><a href="./searchForDonnationList.php">Search Donnation List</a></li>
              <li><a href="./donnerDeleteAccount.php">Delete Account</a></li>
              <li><a href="./rechargeMoneyFromBankAccount.php">Recharge money from bank account</a></li>
              <li><a href="./donnerNoticeBoard.php">See Notice</a></li>
              <li><a href="./sendMessageToAdmin.php">Send message to ADMIN</a></li>
